...
var lightPaths = [
  ...
  new QUANTUM.LightPath(170, 180, 320, 180),
...
// Reference path
var photonR = new QUANTUM.Photon(50, 380);
...
var detectorS = new QUANTUM.PhotonDetector(340, 180);
...
var TEXT = {
  'welcome':
    "Welcome to our first exploration of <i>quantum seeing in the dark</i> with an interferometer. "+
...
$(document).ready(function() {
  // Setting the intro
  QUANTUM._INTRO_MESSAGE = "Welcome to an interaction-free<br>"+
