...
Quantum Seeing In The Dark: Part 1
---------------------------------
...
var projHelper = new QUANTUM.ProjectionHelper();
projHelper.hide();
app.add(projHelper);

// Polarization state indicator
var indicator = new QUANTUM.PolarizationIndicator(80, 70);
indicator.hide();
app.add(indicator);
...
// Polarizers
var polarizer = new QUANTUM.Polarizer();
...
var rotator = new QUANTUM.PolarizationRotator(7.5);
...
var TEXT = {
  'welcome':
    "Welcome to the tutorial on quantum seeing in the dark. Press the cyan help "+
...
tutorial.addStep(
  ...
  { // Pan camera out and move mirrors and splitter into view
    ...
    animation: function(callback) {
      ...
      scene.moveCamera(3, 200, 700, 200, 200, 0, -100, function() {
        ...
        hMirror.move(2, [0, -1000, 0], function() {
          // Animate light paths
          source.blink();
          var path = new QUANTUM.LightPath3D(-300, 0, -290, 0);
          path.animateLengthChange(0.2, 290, function() {
            var path2 = new QUANTUM.LightPath3D(0, 0, 10, 0);
            path2.animateLengthChange(0.2, 340, function() {
              var vPath = new QUANTUM.LightPath3D(350, 0, 350, -10)
              ,   hPath = new QUANTUM.LightPath3D(350, 0, 360, 0);
    ...
    skip: function() {
      ...
      var paths = [
        new QUANTUM.LightPath3D(-300, 0, 0, 0),
        new QUANTUM.LightPath3D(0, 0, 350, 0),
        new QUANTUM.LightPath3D(350, 0, 350, -350),
        new QUANTUM.LightPath3D(350, 0, 700, 0)
      ]
    }
  },
...
tutorial.addStep(
  { // Allow option to go back, prompt next part of the animation
    back: function() {
      ...
      var path = new QUANTUM.LightPath3D(-300, 0, 0, 0);
...
tutorial.addStep(
  ...
  { // Pan camera out and remove mirror/photon source
    animation: function(callback) {
      ...
      scene.moveCamera(3, 200, 700, 200, 200, 0, -100, function() {
        var path = new QUANTUM.LightPath3D(0, 0, -150, 0);
...
$(document).ready(function() {
  // Setting the intro
  QUANTUM._INTRO_MESSAGE = "Welcome to the first exercise on<br>"+
    "quantum seeing in the dark.<br>"+
